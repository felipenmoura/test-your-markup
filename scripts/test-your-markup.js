!function(scope, undefined){
	...
	var lists= {
		programmingLanguages: ['AsciiDots', 'Befunge', 'Brainfuck', 'LOLCODE', 'Malbolge', 'Piet', 'Shakespeare', 'Whitespace', 'Javascript', 'Forth', 'Haskell', 'Racket', 'Common Lisp', 'Scheme', 'Clojure', 'Scala', 'Java', 'Python', 'C#', 'F#', 'C', 'C++', 'Swift', 'Objective-C', 'Rust', 'Julia', 'FORTRAN', 'COBOL', 'Pyret'],
    		usStates: ["AK","AL","AR","AZ","CA","CO","CT","DC","DE","FL","GA","GU","HI","IA","ID", "IL","IN","KS","KY","LA","MA","MD","ME","MH","MI","MN","MO","MS","MT","NC","ND","NE","NH","NJ","NM","NV","NY", "OH","OK","OR","PA","PR","PW","RI","SC","SD","TN","TX","UT","VA","VI","VT","WA","WI","WV","WY"],
    		greekCheat: ['alpha', 'beta', 'gamma', 'delta', 'epsilon', 'zeta', 'eta', 'theta', 'iota', 'kappa', 'lambda', 'my', 'ny', 'xi', 'omikron', 'pi', 'rho', 'sigma', 'tau', 'ypsilon', 'phi', 'chi', 'psi', 'omega'],
